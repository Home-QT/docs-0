//tealium universal tag - utag.loader ut4.40.201611281830, Copyright 2016 Tealium.com Inc. All Rights Reserved. 

var utag_condload=false;try{(function(){function ul(src,a,b){a=document;b=a.createElement('script');b.language='javascript';b.type='text/javascript';b.src=src;a.getElementsByTagName('head')[0].appendChild(b)};if((""+document.cookie).match("utag_env_intel_profile-ssg.intel=([^\S;]*)")){if(RegExp.$1.indexOf("/prod/") === -1) {ul(RegExp.$1);utag_condload=true;__tealium_default_path='//tags.tiqcdn.com/utag/intel/profile-ssg.intel/prod/';}}})();}catch(e){};try{
/*!
...
//set Eloqua Contact ID (short version)
    ...
    wap_tms.events.init = function (type) { //called after GA Pageview sent, used to execute code in sequence
        ...
        if (type == 'ga') {
            ...
            if (utag_data.wa_section.indexOf("simplecore") != -1 || utag_data.wa_section.indexOf("agm") != -1 || utag_data.wa_section.indexOf("iq") != -1  ||  utag_data.wa_section.indexOf("intc") != -1 || utag_data.wa_section.indexOf("elq") != -1 ){
...
//**********************************************************************************************************************************************************************
wap_tms.version.set('1.5,','utf:'); //change version for each update, minor for small update, major for big update
...
//CONFIGURE specific event for each tag 
    switch (true) {
        ...
        case (/^page:realusermonitoring/.test(eventMap)):
            ...
            if (sessionStorage.getItem("wapError") && sessionStorage.getItem("wapError") != null && sessionStorage.getItem("wapErrorUrl") != null && sessionStorage.getItem("wapErrorUrl").indexOf("tms") != -1 ) {
                wap_tms.error.set('javascript-wap,', 'page.error:');
                ga_payload.dimension['169,hit'] =  sessionStorage.getItem("wapErrorUrl");
                ga_payload.dimension['170,hit'] =  sessionStorage.getItem("wapErrorMessage");
...
wap_tms.custom.isAsset = function(linkHref) {
    ...
    wap_tms.captureEloquaContactId = function() {
        if (typeof waGetCookie != "undefined" && waGetCookie("contactId")) {
    ...
    window.onerror = function(msg, url, lineNo, columnNo, error) {
        if(typeof(url)!="undefined" && url.indexOf("tags.tiqcdn") != -1 && !wap_tms.wap_page_error){
            wap_tms.error.set('javascript-wap,', 'event.error:');
...
if (typeof utag == "undefined" && !utag_condload) {
  ...
  utag.cfg = {
    ...
    utid: "intel/profile-ssg.intel/201611281830"
  };
  utag.cfg.v = utag.cfg.template + "201611281830";
  utag.cond={31:0,37:0,38:0,3:0,40:0,42:0,43:0,44:0,45:0,46:0,48:0,49:0,4:0,50:0,51:0,52:0};
...
case '3':try{c[3]|=(d['load_bluekai']=='true')}catch(e){utag.DB(e)}; break;
...
case '42':try{c[42]|=(/\/html5\/hub\/highlights$/i.test(d['dom.url']))||(/\/en-us\/html5$/i.test(d['dom.url']))||(/\/en-us\/android$/i.test(d['dom.url']))}catch(e){utag.DB(e)}; break;
...
case '45':try{c[45]|=(d['dom.url'].toString().toLowerCase().indexOf('software.intel.com/en-us/gamedev/tutorials'.toLowerCase())>-1)||(d['dom.url'].toString().toLowerCase().indexOf('software.intel.com/en-us/gamedev/journey'.toLowerCase())>-1)}catch(e){utag.DB(e)}; break;
case '46':try{c[46]|=(d['dom.url'].toString().toLowerCase().indexOf('software.intel.com/en-us/iot'.toLowerCase())>-1)||(d['dom.url'].toString().toLowerCase().indexOf('software.intel.com/en-us/get-started-edison-windows'.toLowerCase())>-1)}catch(e){utag.DB(e)}; break;
...
case '50':try{c[50]|=(d['dom.url'].toString().toLowerCase().indexOf('software.intel.com/en-us/articles/building-namd-on-intel-xeon-and-intel-xeon-phi-processor'.toLowerCase())>-1)||(d['dom.url'].toString().toLowerCase().indexOf('software.intel.com/en-us/articles/intel-parallel-studio-xe-analysis-tools-on-clusters-with-slurm-srun'.toLowerCase())>-1)||(d['dom.url'].toString().toLowerCase().indexOf('software.intel.com/en-us/articles/an-artificial-intelligence-primer-for-developers'.toLowerCase())>-1)||(d['dom.url'].toString().toLowerCase().indexOf('software.intel.com/en-us/articles/performance-analysis-and-optimization-for-pc-based-vr-applications-from-the-cpu-s'.toLowerCase())>-1)||(d['dom.url'].toString().toLowerCase().indexOf('software.intel.com/en-us/videos/a-discussion-about-intels-strategy-for-network-transformation'.toLowerCase())>-1)||(d['dom.url'].toString().toLowerCase().indexOf('software.intel.com/en-us/blogs/2016/10/25/scalable-software-controller-the-next-evolution-in-intel-rack-scale-design'.toLowerCase())>-1)||(d['dom.url'].toString().toLowerCase().indexOf('software.intel.com/en-us/videos/data-plane-development-dpdk-installation-guide'.toLowerCase())>-1)}catch(e){utag.DB(e)}; break;
case '51':try{c[51]|=(/software\.intel\.com\/en-us\/ai$/i.test(d['dom.url']))}catch(e){utag.DB(e)}; break;
case '52':try{c[52]|=(d['dom.url'].toString().toLowerCase().indexOf('software.intel.com/en-us/recon'.toLowerCase())>-1)}catch(e){utag.DB(e)}; break;}}};utag.pre=function() {    utag.loader.initdata();utag.pagevars();    try{utag.loader.RD(utag.data)}catch(e){utag.DB(e)};    utag.loader.loadrules();        };utag.loader.GET=function(){utag.cl={'_all_':1};utag.pre();
...
function(a,b){ try{ if(/intel-spd-products|-mpi-library|-mpi-benchmarks|whatif-alpha-software|intel-learning-lab|software-evaluation-center|-xe-|-xe20|software-developer-support|-sdp-home|registration-licensing|dpd|development-products|whatif|fortran-library|windows-tool-suites|c-compiler-android|-xe\/|\/improve-performance-with-recompile|technical-enterprise|special-upgrade-program-2013|supported-linux-distributions|-system-studio|\binde\b|\/intel-devtools|native-development-exp|tools-by-segment/.test(b['dom.pathname'])||/development products|parallel|tools for os x|building blocks|library|mpi|development tools|software products|education offerings|tbb|system studio|\binde\b|native development exp/.test(b['dom.title'])||/vectorization|visual fortran compiler|array visualizer|parallel computing|integrated native dev/.test(b['wa_topic'])||/development products|parallel|tools for os x|building blocks|library|mpi|development tools|software products|education offerings|tbb|system studio|\binde\b|native development exp/.test(b['wa_english_title'])||/performance primitives|[\s]xe|vtune|embedded|memory|collector|whatif|compiler|kernel|studio|cluster|cilk plus|integrated native dev|performance analyzers|intel® xdk|energy profiler|opencl™ code builder|media client solutions|system debugger|daal/.test(b['wa_software'])||/product support|product documentation/.test(b['wa_page_type_macro'])||b['dom.pathname'].toString().toLowerCase()=='/en-us/android/articles/intel-hardware-accelerated-execution-manager/'.toLowerCase()||b['dom.pathname'].toString().toLowerCase()=='/en-us/android/articles/intel-hardware-accelerated-execution-manager'.toLowerCase()||b['dom.pathname'].toString().toLowerCase()=='/en-us/android/intel-mobile-development-kit-for-android/'.toLowerCase()||b['dom.pathname'].toString().toLowerCase()=='/en-us/context-sensing-sdk'.toLowerCase()||b['dom.pathname'].toString().toLowerCase()=='/en-us/intel-video-pro-analyzer'.toLowerCase()||b['dom.pathname'].toString().toLowerCase()=='/en-us/multi-os-engine'.toLowerCase()||b['dom.pathname'].toString().toLowerCase()=='/en-us/html5/'.toLowerCase()||b['dom.pathname'].toString().toLowerCase()=='/en-us/xeon-phi/mic'.toLowerCase()){try{b['wa_data_view_name']=(function() { var placeHolder= utag_data.wa_data_view_name;      if (placeHolder != 'empty'){             placeHolder = placeHolder +":"+ "dpd product";      }else{          placeHolder = "dpd product";      }      return placeHolder; })();}catch(e){}} } catch(e){ utag.DB(e) }  },
...
function(a,b){ try{ if(/machine-learning|\/AI\//.test(b['dom.pathname'])||/machine learning|Artificial Intelligence/.test(b['wa_zone'])||b['wa_topic'].toString().toLowerCase().indexOf('machine learning'.toLowerCase())>-1){try{b['wa_data_view_name']=(function() { var placeHolder= utag_data.wa_data_view_name;      if (placeHolder != 'empty'){             placeHolder = placeHolder +":"+ "machine learning";      }else{          placeHolder = "machine learning";      }      return placeHolder; })();}catch(e){}} } catch(e){ utag.DB(e) }  },
...
function(a,b){ try{ if(typeof b['wa_erpm_id']!='undefined'&&b['wa_erpm_id']!=''){b['wa_user_type']='known'} } catch(e){ utag.DB(e) }  },
...
function(a,b){ try{ if(b['wa_topic'].toString().indexOf('datacenter')>-1){b['content_org_initiative']='data-center'} } catch(e){ utag.DB(e) }  }];
  ...
  utag.loader.initcfg = function(){
    utag.loader.cfg={"2":{load:4,send:1,v:201611222224,wait:0,tid:7110},"3":{load:(utag.cond[4] && utag.cond[40]),send:1,v:201608252014,wait:1,tid:7122},"4":{load:4,send:utag.cond[3],v:201610212043,wait:1,tid:2011},"10":{load:utag.cond[31],send:0,v:201610212043,wait:1,tid:5001},"18":{load:utag.cond[37],send:1,v:201603031531,wait:1,tid:20010},"21":{load:4,send:utag.cond[38],v:201610212043,wait:1,tid:20010},"37":{load:utag.cond[42],send:1,v:201607191852,wait:1,tid:8009},"38":{load:utag.cond[43],send:1,v:201607191852,wait:1,tid:8009},"40":{load:utag.cond[45],send:1,v:201607191852,wait:1,tid:8009},"41":{load:utag.cond[44],send:1,v:201607191852,wait:1,tid:8009},"42":{load:utag.cond[46],send:1,v:201607191852,wait:1,tid:8009},"43":{load:utag.cond[48],send:1,v:201610312115,wait:1,tid:8009},"44":{load:utag.cond[49],send:1,v:201611022051,wait:1,tid:8009},"45":{load:utag.cond[50],send:1,v:201611112018,wait:1,tid:8009},"46":{load:utag.cond[52],send:1,v:201611281830,wait:1,tid:8009},"47":{load:utag.cond[51],send:1,v:201611281830,wait:1,tid:8009}};
utag.loader.cfgsort=["2","3","4","10","18","21","37","38","40","41","42","43","44","45","46","47"];
  }
utag.loader.initcfg();
}
...
//START local copy of GA script: //www.google-analytics.com/analytics.js - 10/31/16
...
//START local copy of EC script: https://www.google-analytics.com/plugins/ua/ec.js Updated on: 10/31/16
...
//tealium universal tag - utag.sender.7110 ut4.0.201611281830, Copyright 2016 Tealium.com Inc. All Rights Reserved.
try{
...
//* Config                                                                                    *
//*********************************************************************************************
wap_tms.version.set('2.23,','ga:'); //update version for earch release
...
function trackGaPage(virtualPage, callback) {
    ...
    gawap(function () {
        ...
        for (var i = 0; i < trackers.length; ++i) {
			...
			//Bandwidth detection for mobile
  ...
  u.extend=[];
    ...
    u.send = function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        // Start Mapping
        u.mappings = ["siteid", "limit", "allow_multiple_calls"];
        for (d in utag.loader.GV(u.map)) {
	  if(typeof wa_utag_data[d] != "undefined")
		b[d] = wa_utag_data[d];
          if (b[d] !== undefined && b[d] !== "") {
            e = u.map[d].split(",");
            for (f = 0; f < e.length; f++) {
              if (u.mappings.indexOf(e[f]) > -1) {
                u.data[e[f]] = b[d];
              } else {
                bk_addPageCtx(e[f], b[d]);
              }
            }
          }
        }
        ...
        //d.setAttribute('name', '__bkframe');
        //d.setAttribute('height', '0');
        //d.setAttribute('width', '0');
        //d.setAttribute('frameborder', '0');
        //d.setAttribute('src', 'javascript:void(0)');
        //document.body.appendChild(d);

        // Third parameter is a boolean flag that enables
        // this tag to be fired multiple times
        bk_doJSTag(u.data.siteid, u.data.limit, u.data.allow_multiple_calls);

        //##UTENABLEDEBUG##utag.DB("send:##UTID##:COMPLETE");
      }
    };
    utag.o[loader].loader.LOAD(id);
  }('4', 'intel.profile-ssg.intel'));
} catch (error) {
  utag.DB(error);
}
//end tealium universal tag
...
//tealium universal tag - utag.sender.custom_container ut4.0.201611281830, Copyright 2016 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
    utag.o[loader].sender[id] = u;
