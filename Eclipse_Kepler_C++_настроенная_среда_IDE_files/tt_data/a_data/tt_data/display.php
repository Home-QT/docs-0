...
var builder = new ReopenUrlBuilder("http:\/\/www.adnetworkperformance.com\/ad\/display.php?r=422661&treqn=1882355043&runauction=1&crr=ab0917c197c1c736dcac,,gMjRWZyATZ5AzY1MjNxEWMyEDZiRWNldTZhNzYlFTYkJDZzIWMjZmNENTJzZjMlEmb0QmTKx2aENTJpJnNyUSMENTJklGd2ITJiBHRzUCd2ITJwkTQyUCOycDRzUSZ6l2cGNTJ0RnRyUSbvNmLhlGZl12bmFmcugnRyUiRyUSQzUCc0RHa34f78f6b3b2be06a8802&rtid=583fd76419f61");
var url = builder.build();

    document.write('<iframe width="728" height="90" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="583fd76419f61" frameborder="0" src="'+ url +'" scrolling="no"></iframe>');
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('583fd76419f61').removeAttribute('sandbox');
    }
})();
