...
var changed=false;
var tex_url='http://www.cyberforum.ru/cgi-bin/latex.cgi';
...
function renderEqn(callback)
{
	...
	if(changed)
	{
		...
		val=getEquationStr();
		img.src='http://www.cyberforum.ru/cgi-bin/latex.cgi?' + val;

		var img_code = document.getElementById('latex_formula_img');
		img_code.value='[LATEX]' + val + '[/LATEX]';
		img_code.focus();
		img_code.select();
